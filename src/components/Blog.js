...
const Blog = () => {
  return (
    <div id="blog" className="blog-div">
      ...
      <div className="card-group blog-card-group">
        <div className="card">
          ...
          <div className="card-body">
            ...
            <p className="card-text">
              <small className="text-muted">December 20, 2019</small>
            </p>
          </div>
        </div>
        <div className="card">
          ...
          <div className="card-body">
            ...
            <p className="card-text">
              <small className="text-muted">December 14, 2019</small>
            </p>
          </div>
        </div>
        <div className="card">
          ...
          <div className="card-body">
            ...
            <p className="card-text">
              <small className="text-muted">December 7, 2019</small>
            </p>
          </div>
        </div>
      </div>
      <div className="card-group">
        <div className="card">
          ...
          <div className="card-body">
            ...
            <p className="card-text">
              <small className="text-muted">November 23, 2019</small>
            </p>
          </div>
        </div>
        <div className="card">
          ...
          <div className="card-body">
            ...
            <p className="card-text">
              <small className="text-muted">October 21, 2019</small>
            </p>
          </div>
        </div>
        <div className="card">
          ...
          <div className="card-body">
            <h5 className="card-title blog-card-title">The Demise of form_for</h5>
            <p className="card-text blog-card-text">
              Any new Rails developer will come to appreciate the simplicity and
              effectiveness...
            </p>
            <p className="card-text">
              <small className="text-muted">August 1, 2019</small>
            </p>
          </div>
        </div>
      </div>
